  ...
  return async (userInput, flowState) => {
    ...
    switch (step) {
      ...
      case "collect-fullname": {
        const extractedName = commandParser.extractEntityValue(
          userInput,
          "fullname",
        );
        ...
        if (!validateFullName(extractedName)) {
          return {
            response:
              "I need a valid name with at least two characters. Please tell me your full name again.",
            flowState: {
              ...flowState,
      ...
      case "confirm-fullname": {
        ...
        if (confirmation === "confirm") {
          ...
          return {
            response:
              "I did not understand. Please say correct to confirm, or repeat to say your name again.",
            flowState,
            requiresInput: true,
          };
        } else {
          return {
            response:
              "Please say correct to confirm, or repeat to say your name again.",
            flowState,
            requiresInput: true,
          };
        }
      ...
      case "collect-email": {
        const extractedEmail = commandParser.extractEntityValue(
          userInput,
          "email",
        );
        ...
        if (!validateEmail(extractedEmail)) {
          return {
            response:
              "That doesn't sound like a valid email address. Please say your email again, like john at example dot com.",
            flowState: {
              ...flowState,
              tempEmail: undefined,
            },
      ...
      case "confirm-email": {
        ...
        if (confirmation === "confirm") {
          return {
            response:
              "Perfect! Now, please tell me your password. It must be at least 6 characters.",
            flowState: {
              ...flowState,
          ...
          return {
            response:
              "I did not understand. Please say correct to confirm, or repeat to say your email again.",
            flowState,
            requiresInput: true,
          };
        } else {
          return {
            response:
              "Please say correct to confirm, or repeat to say your email again.",
            flowState,
            requiresInput: true,
          };
        }
      ...
      case "collect-password": {
        const extractedPassword = commandParser.extractEntityValue(
          userInput,
          "password",
        );
        ...
        if (!validatePassword(extractedPassword)) {
          return {
            response:
              "Password must be at least 6 characters long. Please say your password again.",
            flowState: {
              ...flowState,
        ...
        return {
          response:
            "Password received. Say correct to confirm, or repeat to say it again.",
          flowState: {
            ...flowState,
      ...
      case "confirm-password": {
        ...
        if (confirmation === "confirm") {
          try {
            ...
            if (response.data?.user) {
              ...
              return {
                response: `Account created successfully! Welcome, ${response.data.user.fullname}. You are now logged in.`,
                completed: true,
                requiresInput: false,
              };
            }
            ...
            return {
              response: `Sorry, ${msg}. Please try again by saying sign up.`,
              completed: true,
              requiresInput: false,
            };
          }
        ...
        if (confirmation === "repeat") {
          return {
            response: "Please say your password again.",
            flowState: { ...flowState, step: "collect-password" },
            requiresInput: true,
          };
        }
        ...
        return {
          response: "Please say correct or repeat.",
          flowState,
          requiresInput: true,
        };
      }
    ...
    switch (step) {
      ...
      case "collect-email": {
        ...
        if (!validateEmail(extractedEmail)) {
          return {
            response:
              "That doesn't sound like a valid email address. Please say your email again.",
            flowState: {
              ...flowState,
              tempEmail: undefined,
            },
      ...
      //     return {
      //       response:
      //         "I did not understand. Please say correct to confirm, or repeat to say your password again.",
      //       flowState,
      //       requiresInput: true,
      //     };
      //   } else {
      //     return {
      //       response:
      //         "Please say correct to confirm, or repeat to say your password again.",
      //       flowState,
      //       requiresInput: true,
      //     };
      //   }
        ...
        if (confirmation === "confirm") {
          try {
            ...
            if (response.data?.user) {
              ...
              return {
                response: `Login successful! Welcome back, ${response.data.user.fullname}.`,
                completed: true,
                requiresInput: false,
              };
            }
            ...
            return {
              response: `Sorry, ${msg}. Please try again by saying log in.`,
              completed: true,
              requiresInput: false,
            };
          }
