...
//           return {
//             response:
//               "Collecting delivery address. Please tell me your complete delivery address.",
...
//         return {
//           response:
//             "Please say confirm to proceed with payment, or cancel to go back.",
//           flowState,
//           requiresInput: true,
//         };
//       }
...
//           return {
//             response:
//               "Please provide a complete delivery address with at least 10 characters.",
//             flowState,
//             requiresInput: true,
//           };
//         }
...
//           return {
//             response:
//               "Order created. Opening payment window. A payment window has opened on your screen. Complete the payment using card, U P I, or net banking as shown. Say done when payment is complete, or cancel to stop.",
//             flowState: {
//               ...flowState,
//               step: "await-payment",
...
//           return {
//             response:
//               "Payment details missing. This usually means payment was not completed. Say retry to try again, or contact support if amount was deducted.",
//             flowState: {
//               ...flowState,
//               step: "error",
...
//             return {
//               response:
//                 "Maximum retry attempts reached. Please contact support or try again later. Your cart is saved.",
//               completed: true,
//               requiresInput: false,
//             };
//           }
...
//         return {
//           response:
//             "Say retry to try payment again, keep shopping to continue browsing, or contact support for help.",
//           flowState,
//           requiresInput: true,
//         };
//       }
...
//         return {
//           response:
//             "Something went wrong with checkout. Say view cart to start over, or contact support for assistance.",
//           completed: true,
//           requiresInput: false,
//         };
//     }
  ...
  return async (userInput, flowState) => {
    ...
    switch (step) {
      ...
      case "init": {
        // if (!userId) {
        //   return {
        //     response: "Please log in to checkout.",
        //     completed: true,
        //   };
        // }
        ...
        return {
          response: `You have ${itemCount} items totaling ${total} rupees. Proceed to payment? Say yes or no.`,
      ...
      ========================= */
      case "confirm": {
        if (/\b(yes|confirm|proceed|pay)\b/i.test(userInput)) {
          if (onPaymentSuccess) {
            onPaymentSuccess({
              items,
              total,
          ...
          return {
            response:
              "Payment successful. Order placed! Say view orders to see your purchases.",
            completed: true,
            action: "payment-success",
          };
        }

        if (/\b(no|cancel|stop)\b/i.test(userInput)) {
          if (onCancel) onCancel();

          return {
            response: "Checkout cancelled. Returning to cart.",
            completed: true,
          };
        }
